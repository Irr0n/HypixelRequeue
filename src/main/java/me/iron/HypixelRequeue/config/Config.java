package me.iron.HypixelRequeue.config;
...
public class Config {
    ...
    public ArrayList initConfigValue(String category, String key, String type) {
        ...
        if (type.equals("int")) {
            ...
            valueArray.set(2, config.get(category, key, "").getString());
    ...
    public void initConfigSettingsFields() {
        ...
        for (int i = 0; i < mainFields.length; i++) {
            ...
            String type = mainFields[i].getType().getSimpleName();
        ...
        for (Class aClass : classes) {
            ...
            for (int i = 0; i < subFields.length; i++) {
                String fieldType = subFields[i].getType().getSimpleName();
